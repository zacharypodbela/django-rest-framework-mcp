        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order_number",
                    models.CharField(
                        help_text="Unique order identifier", max_length=20, unique=True
                    ),
                ),
                (
                    "customer_name",
                    models.CharField(
                        help_text="Customer's full name (required)", max_length=100
                    ),
                ),
                (
                    "customer_email",
                    models.EmailField(
                        help_text="Customer's email address (required)", max_length=254
                    ),
                ),
                (
                    "shipping_address",
                    models.TextField(help_text="Complete shipping address (required)"),
                ),
                (
                    "notes",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product_name",
                    models.CharField(
                        help_text="Name of the product (required)", max_length=200
                    ),
                ),
                (
                    "quantity",
